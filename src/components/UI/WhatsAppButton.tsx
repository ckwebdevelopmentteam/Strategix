  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4">
      ...
      <a
        ...
        className="flex items-center justify-center sm:justify-start bg-[#25D366] text-white rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_30px_rgba(37,211,102,0.6)] hover:-translate-y-1 transition-all duration-300 animate-pulse-border w-14 h-14 sm:w-auto sm:h-14 sm:pr-6 sm:pl-1"
      >
        {/* Icon part */}
